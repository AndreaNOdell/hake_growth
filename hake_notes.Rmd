...
Today I continued to work in the sdm-TMB.r script. I created a new section titled **Pairwise covariate model exploration** where I begin the model exploration Kristin and I spoke about (see notes above). 

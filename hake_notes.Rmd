...
- Kelli: cohort effect of ageing error  
    ...
    - maybe add a cohort efect for large cohorts
...
Should I include model validation? If so, how? 75%/25% training/testing? Could be included in future work when we are focused on predicting, whereas right now just looking at patterns.
